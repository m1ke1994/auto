...
export const projects: Project[] = [
  ...
  {
  id: "14",
  title: "TrackNode - аналитика и разработка сайтов",
  category: "multipage",
  shortDescription: "Платформа TrackNode объединяет аналитику, заявки, SEO-инструменты, AI-рекомендации, создание и подключение сайтов.",
  fullDescription: "TrackNode помогает создавать сайты под заказ и подключать аналитику к уже существующим проектам. Внутри платформы есть личный кабинет, заявки, SEO-аудит, анализ конкурентов, AI-рекомендации, отчеты, Telegram-уведомления и изоляция данных разных сайтов.",
  techStack: ["Vue 3", "Django", "Django REST Framework", "PostgreSQL", "Redis", "Celery", "Docker", "Nginx"],
  role: "Проектирование архитектуры, backend, frontend-панель, аналитика, SEO-инструменты, multi-tenant логика, деплой и DevOps.",
  images: ["/tracknode.JPG"],
  demoUrl: "https://tracknode.ru/",
  results: "Реализована платформа для разработки и подключения сайтов с аналитикой, заявками, SEO-аудитом, AI-рекомендациями и отдельными идентификаторами аналитики для каждого сайта."
},
{
  id: "15",
