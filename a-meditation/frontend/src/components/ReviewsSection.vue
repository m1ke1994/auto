...
const fallbackReviews = [
  {
    ...
    avatar: '/public-site-assets/images/IMG_1245.JPG',
  ...
  },
  {
    name: 'Участница игры',
    date: 'Отзыв из Telegram',
    avatar: '/public-site-assets/images/IMG_1246.JPG',
  ...
  },
  {
    name: 'Участница игры',
    date: 'Отзыв из Telegram',
    avatar: '/public-site-assets/images/IMG_1249.JPG',
  ...
  },
  {
    name: 'Участница игры',
    date: 'Отзыв из Telegram',
    avatar: '/public-site-assets/images/IMG_1988.JPG',
...
const reviews = computed(() => {
  ...
  const mapped = items
    ...
    .map((item) => ({
      ...
      avatar: item.avatar || '/public-site-assets/images/IMG_1245.JPG',
      text: item.text,
    }))
