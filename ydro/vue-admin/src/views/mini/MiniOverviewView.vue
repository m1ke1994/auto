  ...
  <div class="space-y-4">
    ...
    <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
      <article class="surface" v-for="item in [
        ...
        <p class="mt-2 text-2xl font-bold text-[#17223B]">{{ item.value }}</p>
      </article>
    </div>

    <div class="grid gap-4 lg:grid-cols-2">
      <section class="surface">
        <h2 class="text-base font-semibold text-[#17223B]">Источники</h2>
      ...
      <section class="surface">
        <h2 class="text-base font-semibold text-[#17223B]">Устройства</h2>
        <div class="mt-3 overflow-x-auto">
          <table class="data-table">
            <thead>
              <tr class="border-b border-slate-100 text-left text-slate-500">
    ...
    <section class="surface">
      <h2 class="text-base font-semibold text-[#17223B]">Вовлечённость</h2>
